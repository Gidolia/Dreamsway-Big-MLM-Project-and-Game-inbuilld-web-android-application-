            ...
            <div class="main-content-inner">
             <div class="row">
                <div class="col-12 mt-12">
                    <div class="card">
                        <div class="card-body">
                            <h4> Welcome <?php echo $d_detail[name];?> </h4>
                            <br>&nbsp;
                            <?php
                 if($d_detail[a_status]=='y'){?>
                 <div class="alert alert-success" role="alert">
                                            <strong>Your Account Is Active</strong> </div>
                ...
                <!-- seo fact area start -->
                                ...
                                <div class="card">
                                    <div class="seo-fact sbg3">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-shopping-cart"></i>Shopping Point</div>
                                           <h2>
                                              <?php 
                  echo $d_detail[shoping_point];
                  ?> 
                                           </h2>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg1">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="fa fa-sitemap"></i> Level Commission</div>
                                            <h2><?php 
                            ...
                            <div class="col-md-6 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-bag"></i> Auto Matrix Income</div>
                                            <h2> <?php 
                  ...
                  ?></h2>
                            ...
                            <div class="col-md-6 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg3">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-shopping-cart-full"></i>Ecommerce Income</div>
                                           <h2>
                                              <?php 
                  $scd="SELECT * FROM `withdrawal_wallet` WHERE `d_id`='$_SESSION[d_id]' AND `income_for`='Recharge'";
                  $cdr=$con->query($scd);
                  $ri_ic=0;
                  ...
                  ?> 
                        ...
                        <?php /*    <div class="col-md-6 mt-5 mb-3">
                                <div class="card">
                            ...
                            <div class="col-md-6 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-world"></i> Global Income</div>
                                            <h2> <?php 
                                $g_i=0;
                            ...
                            <div class="col-md-6 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg3">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-world"></i> Club Income</div>
                                            <h2> <?php 
                    ///////////////////bronze tree
                  ...
                  ?>
                            ...
                            <div class="col-md-6 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg4">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-world"></i> Club Sponser Income</div>
                                            <h2> <?php 
                    ///////////////////bronze tree
                  ...
                  ?>
                            ...
                            <div class="col-md-6 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-world"></i> Upgrade Automatrix Income</div>
                                            <h2> <?php 
                    ///////////////////bronze tree
                  ...
                  ?>
                            ...
                            <div class="col-md-6 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg3">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-plus"></i>Total Income</div>
                                           <h2>
                                              <?php echo $totn;?>
                                           </h2>
                                        </div>
