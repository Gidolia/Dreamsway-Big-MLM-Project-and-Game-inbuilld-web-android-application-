...
<body>
    ...
    <div class="page-container">
        ...
        <table class="table text-center">
            <thead class="text-uppercase bg-success"><tr class="text-white"><th>Sr. no.</th><th>Activated ID</th><th>Activated Name</th><th>Level</th><th>Amount</th><th>Date/Time</th></tr></thead>
            <?php
            $a=0;
            $t1=0;
            $t2=0;
