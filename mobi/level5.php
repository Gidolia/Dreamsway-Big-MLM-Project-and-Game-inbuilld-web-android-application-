    ...
    <div class="page-container">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="btn-group mr-2" role="group" aria-label="First group">
                                ...
                                <a href="level5.php"><button type="button" class="btn btn-primary mb-xl-3 active">5</button></a>
        ...
        <table class="table text-center">
          ...
          <?php
            ...
            ?><tr>
                <td><?php echo $a;?></td><td>DS<?php echo $temp[$x];?></td><td><?php echo $temp1[$x];?></td><td><?php echo $temp3[$x];?></td><td><?php echo $temp4[$x];?></td><td><?php if($temp2[$x]=="y"){$green++; ?> <span class="badge badge-success">Active</span><?php }
