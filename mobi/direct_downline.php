...
<body>
    ...
    <div class="page-container">
        ...
        <table class="table text-center">
            <thead class="text-uppercase bg-success"><tr class="text-white"><th>Sr. no.</th><th>D ID</th><th>Name</th><th>Activate Status</th><th>Mobile</th><th>Joining Date</th></tr></thead>
            <tbody>
            <?php
            $a=0;
            $green=0;
            ...
            <tr>
                ...
                <td style="white-space:nowrap;"><?php echo $d[reg_date];?></td>
