...
<body>
    ...
    <div class="page-container">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="btn-group mr-2" role="group" aria-label="First group">
                                ...
                                <a href="level2.php">    <button type="button" class="btn btn-primary mb-xl-3 active">2</button></a>
        ...
        <table class="table text-center">
            <thead class="text-uppercase bg-success"><tr class="text-white"><th>Sr. no.</th><th>D ID</th><th>Name</th><th>Mobile</th><th>Joinning Date</th><th>Activate Status</th></tr></thead>
            <tbody>
          <?php
            $a=0;
            $green=0;
            ...
            ?><tr>
                <td><?php echo $a;?></td><td>DS<?php echo $temp[$x];?></td><td><?php echo $temp1[$x];?></td> <td><?php echo $temp3[$x];?></td>
                <td><?php echo $temp4[$x];?></td><td><?php if($temp2[$x]=="y"){ $green++; ?> <span class="badge badge-success">Active</span><?php }
