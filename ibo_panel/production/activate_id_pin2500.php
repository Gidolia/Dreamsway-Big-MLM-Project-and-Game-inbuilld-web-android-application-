...
<link rel="icon" href="../../small_logo.jpg" type="image/ico" />
    <title>DREAMSWAY || Activate id</title>
    ...
    <div class="container body">
      <div class="main_container">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Activate ID Through pin 2500Rs</h3>
              </div>
            </div>
        ...
        <table class="table table-striped table-bordered">
            <thead><tr><th>Your Pin Balance</th><th><?php echo $d_detail[pin_2_wallet]+0;?></th></tr></thead>
            
            </table>
            <form class="form-horizontal form-label-left" action="process_activate_2500pin_id.php" method="post" name="myForm" onsubmit="return validateForm()">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Account Activate History</h2>
        ...
        <table class="table table-striped table-bordered" value ="<h2>Withdrawl history</h2>" id="datatable">
            ...
            <?php
            $a=0;
            $g="SELECT * FROM `pin_wallet_2600` WHERE `d_id`='$_SESSION[d_id]' AND `note`='Activated ID'";
            $dc=$con->query($g);
            ...
            <tr>
                ...
                <td><?php echo "DS".$d[activated_id];?></td>
                <?php
