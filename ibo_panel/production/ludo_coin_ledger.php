...
<link rel="icon" href="../../small_logo.jpg" type="image/ico" />
    <title>Dreamsway || Playing coin Ledger View <?php echo $_SESSION[d_id];?></title>
    ...
    <div class="container body">
      <div class="main_container">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Playing Coin Leadger View</h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Your Playing Coin Ledger View </h2>
        ...
        <table class="table table-striped table-bordered jambo_table"  id="datatable">
            ...
            <?php
            $a=0;
            $g="SELECT * FROM `ludo_coin_history` WHERE `d_id`='$_SESSION[d_id]'";
            $dc=$con->query($g);
            ...
            <tr>
                ...
                <?php }?></td>
                <th><?php echo $d[coin];?></th>
                <th><?php echo $d[a_coin];?></th>
