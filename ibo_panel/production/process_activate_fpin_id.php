...
///////////////////////////level 1 200/-
 ...
 else{echo "<script>alert('This Account is Already Activated'); location.href='activate_id_pin.php';</script>";}
}else{echo "<script>alert('You Dont have balance'); location.href='activate_id_pin.php';</script>";}
}else{
    echo "<script>alert('Sucessfully Activated'); location.href='activate_id_pin.php';</script>";
}
}
