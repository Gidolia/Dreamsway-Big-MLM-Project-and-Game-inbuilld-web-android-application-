...
<link rel="icon" href="../../small_logo.jpg" type="image/ico" />
    <title>Dreamsway || Upgrade Pin Transfer</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Transfer Upgrade Pins Confirmation asked</h3>
              </div>
            </div>
