    ...
    <div class="container body">
      <div class="main_container">
        ...
        <table class="table table-striped table-bordered">
            <thead><tr><th>Your Upgrade Pin Balance</th><th><?php echo $d_detail[u_pin_wallet]+0;?></th></tr></thead>
            ...
            <form class="form-horizontal form-label-left" action="process_activate_fpin_id.php" method="post" name="myForm" onsubmit="return validateForm()">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="number" class="form-control" name="a_d_id" onKeyUp="showHint(this.value)">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Upgrade Account History Pin</h2>
