...
<link rel="icon" href="../../small_logo.jpg" type="image/ico" />
    <title>Dreamsway || Coins Genarate</title>
                      ...
                      <div class="row">
                        <div class="table">
                          <table class="table table-striped jambo_table">
                            ...
                            <tbody>
                              <tr>
                                <td><?php echo $_POST[coins];?></td>
                                <th>Playing Coin</th>
                                <th><?php 
                                echo $coins_amount;?> Rs</th>
                              </tr>
                            </tbody>
                          </table>
                        </div>
                            ...
                            <table class="table">
                              <tbody>
                                <tr>
                                  ...
                                  <td><?php 
                                echo $coins_amount;?> Rs</td>
                                </tr>
                                
                                <tr>
                                  <th>Total:</th>
                                  <th><?php echo $coins_amount;?> Rs</th>
                                </tr>
                                <tr>
                                  <th></th>
                                  <th>
                            <form action="process_buy_coin.php" method="post">
                                          <input type="hidden" name="coins" value="<?php echo $_POST[coins];?>">
                                      
                          <input type="submit" name="confirm_buy_coin" value="Confirm Buy Playing Coins" class="btn btn-round btn-primary">
                          </form>
                          </th>
                                </tr>
                              </tbody>
