...
function send_sms($mobile, $message, $sms_for, $d_id)
{
	...
	$url = 'http://sms.hspsms.com/sendSMS?username=dreamsway&message='.$dd.'&sendername=DREAMS&smstype=TRANS&numbers='.$mobile.'&apikey=a238e924-ad9e-43aa-80c4-8e8d51ba092b';
	$ch = curl_init($url);
...
//distribute_recharge_income(468129,75);
