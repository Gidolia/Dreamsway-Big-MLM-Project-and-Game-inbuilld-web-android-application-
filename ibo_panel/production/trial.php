...
if(isset($_POST[mob_recharge]))
{
    ...
    $urla = 'https://www.rechargedaddy.in/RDRechargeAPI/RechargeAPI.aspx?MobileNo=9588417929&APIKey=dRvdlFf3mmFBSL2nmdoDcQFznBSoqeQ7sxV&REQTYPE=RECH&REFNO='.$unq_id.'&SERCODE=AR&CUSTNO='.$_POST[mobile].'&REFMOBILENO='.$_POST[mobile].'&AMT=10&STV=0&RESPTYPE=JSON';
		$ch = curl_init($urla);
