...
<?php include "level_button.php";?>
       ...
       <?php
        ...
        <table class="table table-striped table-bordered">
            ...
            ?>
            <tr>
                <td><?php echo $a;?></td><td>DS<?php echo $temp[$x];?></td><td><?php echo $temp1[$x];?></td><td><?php if($temp2[$x]=="y"){ ?> <button type="button" class="btn btn-success">Activate</button> <?php }
