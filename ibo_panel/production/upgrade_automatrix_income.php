...
<link rel="icon" href="../../small_logo.jpg" type="image/ico" />
    <title>Dreamsway ||Upgrade Auto Matrix Income</title>
    ...
    <div class="container body">
      <div class="main_container">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Upgrade Auto Matrix Income</h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-8 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Your Upgrade Auto Matrix Income Level View </h2>
        ...
        <table class="table table-striped table-bordered">
            ...
            /////////////////////////
            ////////////////////////////////////lv 1
            $g1="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='1'";
            $dc1=$con->query($g1);
            $a1=$dc1->num_rows;
            $am1=$a1*25;
            $meter1=$am1*100/50;
            ...
            /////////////////////////
            ////////////////////////////////////lv 2
            $g2="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='2'";
            $dc2=$con->query($g2);
            $a2=$dc2->num_rows;
            $am2=$a2*15;
            $meter2=$am2*100/60;
            ...
            /////////////////////////
            ////////////////////////////////////lv 3
            $g3="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='3'";
            $dc3=$con->query($g3);
            $a3=$dc3->num_rows;
            $am3=$a3*10;
            $meter3=$am3*100/80;
            ...
            /////////////////////////
            ////////////////////////////////////lv 4
            $g4="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='4'";
            $dc4=$con->query($g4);
            $a4=$dc4->num_rows;
            $am4=$a4*10;
            $meter4=$am4*100/160;
            ...
            /////////////////////////
            ////////////////////////////////////lv 5
            $g5="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='5'";
            $dc5=$con->query($g5);
            $a5=$dc5->num_rows;
            $am5=$a5*12;
            $meter5=$am5*100/384;
            ...
            /////////////////////////
            ////////////////////////////////////lv 6
            $g6="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='6'";
            $dc6=$con->query($g6);
            $a6=$dc6->num_rows;
            $am6=$a6*10;
            $meter6=$am6*100/640;
            ...
            /////////////////////////
            ////////////////////////////////////lv 7
            $g7="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='7'";
            $dc7=$con->query($g7);
            $a7=$dc7->num_rows;
            $am7=$a7*10;
            $meter7=$am7*100/1280;
            ...
            /////////////////////////
            ////////////////////////////////////lv 8
            $g8="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='8'";
            $dc8=$con->query($g8);
            $a8=$dc8->num_rows;
            $am8=$a8*10;
            $meter8=$am8*100/2560;
            ...
            /////////////////////////
            ////////////////////////////////////lv 9
            $g9="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='9'";
            $dc9=$con->query($g9);
            $a9=$dc9->num_rows;
            $am9=$a9*12.5;
            $meter9=$am9*100/6400;
            ...
            /////////////////////////
            ////////////////////////////////////lv 10
            $g10="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='10'";
            $dc10=$con->query($g10);
            $a10=$dc10->num_rows;
            $am10=$a10*12.5;
            $meter10=$am10*100/12800;
            if($meter10!=0)
            {
            ?>
            ...
            /////////////////////////
            ////////////////////////////////////lv 11
            $g11="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='11'";
            $dc11=$con->query($g11);
            $a11=$dc11->num_rows;
            $am11=$a11*12.5;
            $meter11=$am11*100/25600;
            if($meter11!=0)
            {
            ?>
            ...
            /////////////////////////
            ////////////////////////////////////lv 12
            $g12="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='12'";
            $dc12=$con->query($g12);
            $a12=$dc12->num_rows;
            $am12=$a12*12.5;
            $meter12=$am12*100/51200;
            if($meter12!=0)
            {
            ?>
            ...
            /////////////////////////
            ////////////////////////////////////lv 13
            $g13="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='13'";
            $dc13=$con->query($g13);
            $a13=$dc13->num_rows;
            $am13=$a13*12.5;
            $meter13=$am13*100/102400;
            if($meter13!=0)
            {
            ?>
            ...
            /////////////////////////
            ////////////////////////////////////lv 14
            $g14="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='14'";
            $dc14=$con->query($g14);
            $a14=$dc14->num_rows;
            $am14=$a14*12.5;
            $meter14=$am14*100/204800;
            if($meter14!=0)
            {
            ?>
            ...
            /////////////////////////
            ////////////////////////////////////lv 15
            $g15="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='15'";
            $dc15=$con->query($g15);
            $a15=$dc15->num_rows;
            $am15=$a15*25;
            $meter15=$am15*100/819200;
            if($meter15!=0)
            {
            ?>
            ...
            /////////////////////////
            ////////////////////////////////////lv 16
            $g16="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='16'";
            $dc16=$con->query($g16);
            $a16=$dc16->num_rows;
            $am16=$a16*50;
            $meter16=$am16*100/3276800;
            if($meter16!=0)
            {
            ?>
            ...
            /////////////////////////
            ////////////////////////////////////lv 17
            $g17="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='17'";
            $dc17=$con->query($g17);
            $a17=$dc17->num_rows;
            $am17=$a17*75;
            $meter17=$am17*100/9830400;
            if($meter17!=0)
            {
            ?>
            ...
            /////////////////////////
            ////////////////////////////////////lv 18
            $g18="SELECT * FROM `u_auto_matrix_income` WHERE `d_id`='$_SESSION[d_id]' AND `level`='18'";
            $dc18=$con->query($g18);
            $a18=$dc18->num_rows;
            $am18=$a18*100;
            $meter18=$am18*100/26214400;
            if($meter18!=0)
            {
            ?>
