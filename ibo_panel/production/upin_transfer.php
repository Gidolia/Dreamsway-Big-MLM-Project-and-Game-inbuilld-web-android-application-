    ...
    <div class="container body">
      <div class="main_container">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      <form action="confirm_transfer_upin.php" method="post">
        <table class="table table-striped table-bordered">
            <thead><tr><th>Upgrade PIN Wallet Balance</th><th><?php echo $d_detail[u_pin_wallet]+0;?></th></tr></thead>
            <tr>
                <th>To ID</th>
                <td><input type="text" name="to_d_id"></td>
            </tr>
            <tr>
                <th>Upgrade Pin To Transfer</th>
                <td><input type="number" name="pins"></td>
            </tr>
            <tr>
                <th></th>
                <td><input type="submit" name="transfer_upin"></td>
            </tr>
            </table>
            </form>
            </div>
        ...
        <table class="table table-striped table-bordered" value ="<h2>Withdrawl history</h2>" id="datatable">
            ...
            <?php
            $a=0;
            $g="SELECT * FROM `u_pin_wallet` WHERE `d_id`='$_SESSION[d_id]'";
            $dc=$con->query($g);
