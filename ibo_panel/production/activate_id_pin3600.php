    ...
    <div class="container body">
      <div class="main_container">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Activate ID Through pin 3600Rs</h3>
              </div>
            </div>
        ...
        <table class="table table-striped table-bordered">
            <thead><tr><th>Your Pin Balance</th><th><?php echo $d_detail[pin_3_wallet]+0;?></th></tr></thead>
            
            </table>
            <form class="form-horizontal form-label-left" action="process_activate_3600pin_id.php" method="post" name="myForm" onsubmit="return validateForm()">
        ...
        <table class="table table-striped table-bordered" value ="<h2>Withdrawl history</h2>" id="datatable">
            ...
            <?php
            $a=0;
            $g="SELECT * FROM `pin_wallet_3600` WHERE `d_id`='$_SESSION[d_id]' AND `note`='Activated ID'";
            $dc=$con->query($g);
