...
<?php
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                        <h4>PIN Current Wallet = <?php echo $xzxx[pin_wallet]+0;?>/-</h4>
        ...
        <table class="table table-striped table-bordered" id="datatable">
            ...
            <?php
            $a=0;
            $g="SELECT * FROM `pin_wallet` WHERE `d_id`='$_GET[d_id]' ORDER BY `pin_wallet`.`pw_id` DESC";
            $dc=$con->query($g);
         ...
         <?php
            if(isset($_POST[opperaa]))
            {
                ...
                $fet=$xx->fetch_assoc();
                    ...
                    $wallet=$fet[pin_wallet]+$_POST[amount];
                    $r="UPDATE `distributor` SET `pin_wallet` = '$wallet' WHERE `distributor`.`d_id` = '$_POST[d_id]';";
