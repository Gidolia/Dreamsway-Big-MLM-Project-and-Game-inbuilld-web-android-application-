          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Online Add Money History</h2>
                  ...
                  <div class="x_content">
                     ...
                     <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                          <?php 
                                $e="SELECT * FROM `temp_txn_handler`";
                                $d=$con->query($e);
                                ...
                                <th> <?php echo $r['txn_id'];?></th>
                                 ...
                                 <td>
                                   ...
                                   <?php
                                         ...
                                         <input type="submit" name="reject_recharge" value="Failed" class="btn btn-danger">
                                   <?php }?>
