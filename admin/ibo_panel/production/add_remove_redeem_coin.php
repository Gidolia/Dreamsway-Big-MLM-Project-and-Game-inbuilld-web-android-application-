...
<link rel="icon" href="../../small_logo.jpg" type="image/ico" />
    <title>DREAMSWAY || Add Remove Redeem Coin</title>
...
<?php
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>ADD/Remove Redeem Coin</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                        <h4>Redeem Coin = <?php echo $xzxx[ludo_wallet]+0;?>/-</h4>
         ...
         <?php
            if(isset($_POST[opperaa]))
            {
                ...
                $fet=$xx->fetch_assoc();
                    ...
                    $wallet=$fet[ludo_wallet]+$_POST[amount];
                    $r="UPDATE `distributor` SET `ludo_wallet` = '$wallet' WHERE `distributor`.`d_id` = '$_POST[d_id]';";
                    
                    $r .="INSERT INTO `ludo_wallet_history` (`lwh_id`, `d_id`, `date`, `time`, `coin`, `a_coin`, `note`, `activated_d_id`, `level`, `type`, `win_rank`) VALUES (NULL, '$_POST[d_id]', '$date', '$time', '$_POST[amount]', '$wallet', 'Admin Add', '', '', '+', '');";
		...
		location.href='add_remove_redeem_coin.php?d_id=$_POST[d_id]';</script>";
                }
                else{
		...
		location.href='add_remove_redeem_coin.php?d_id=$_POST[d_id]';</script>";
                ...
                $fet=$xx->fetch_assoc();
                    ...
                    $r .="INSERT INTO `ludo_wallet_history` (`lwh_id`, `d_id`, `date`, `time`, `coin`, `a_coin`, `note`, `activated_d_id`, `level`, `type`, `win_rank`) VALUES (NULL, '$_POST[d_id]', '$date', '$time', '$_POST[amount]', '$wallet', 'Admin Remove', '', '', '-', '');";
