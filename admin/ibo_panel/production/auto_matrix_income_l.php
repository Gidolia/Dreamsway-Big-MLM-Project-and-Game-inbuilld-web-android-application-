    ...
    <div class="container body">
      <div class="main_container">
        ...
        <table class="table table-striped table-bordered" id="datatable-buttons">
            <thead><tr><th>Sr. no.</th><th>Date / Time</th><th>Amount</th><th>Level</th><th>D ID</th></tr></thead>
            <?php
            $a=0;
            $g="SELECT * FROM `auto_matrix_income` ORDER BY `auto_matrix_income`.`ami_id` DESC";
            $dc=$con->query($g);
