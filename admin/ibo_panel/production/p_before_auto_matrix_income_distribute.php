...
if($que1->num_rows>0)
{
    ...
    $sql="INSERT INTO `auto_matrix_income` (`ami_id`, `amt_id`, `d_id`, `date`, `time`, `amount`, `level`, `for_amt_id`) VALUES (NULL, '$fet1[amt_id]', '$fet1[d_id]', '$date', '$time', '10', '1', '$amt_id');";
    $dddd1="SELECT * FROM `distributor` WHERE `d_id`='$fet1[d_id]'";
    $sdcdd1=$con->query($dddd1);
    $lnm1=$sdcdd1->fetch_assoc();
    $withdrawal_wallet1=$lnm1[withdrawal_wallet]+10;
    $sql .="INSERT INTO `withdrawal_wallet` (`ww_id`, `d_id`, `date`, `time`, `type`, `amount`, `a_bal`, `note`, `income_for`, `from_d_id`, `to_d_id`, `activated_id`, `level`) VALUES (NULL, '$fet1[d_id]', '$date', '$time', '+', '10', '$withdrawal_wallet1', 'Auto Matrix Income', 'Auto Matrix', '', '', '', '1');";
...
if($que2->num_rows>0)
{
    $sql .="INSERT INTO `auto_matrix_income` (`ami_id`, `amt_id`, `d_id`, `date`, `time`, `amount`, `level`, `for_amt_id`) VALUES (NULL, '$fet2[amt_id]', '$fet2[d_id]', '$date', '$time', '12', '2', '$amt_id');";
    $dddd2="SELECT * FROM `distributor` WHERE `d_id`='$fet2[d_id]'";
    $sdcdd2=$con->query($dddd2);
    $lnm2=$sdcdd2->fetch_assoc();
    $withdrawal_wallet2=$lnm2[withdrawal_wallet]+12;
    $sql .="INSERT INTO `withdrawal_wallet` (`ww_id`, `d_id`, `date`, `time`, `type`, `amount`, `a_bal`, `note`, `income_for`, `from_d_id`, `to_d_id`, `activated_id`, `level`) VALUES (NULL, '$fet2[d_id]', '$date', '$time', '+', '12', '$withdrawal_wallet2', 'Auto Matrix Income', 'Auto Matrix', '', '', '', '2');";
...
if($que3->num_rows>0)
{
    $sql .="INSERT INTO `auto_matrix_income` (`ami_id`, `amt_id`, `d_id`, `date`, `time`, `amount`, `level`, `for_amt_id`) VALUES (NULL, '$fet3[amt_id]', '$fet3[d_id]', '$date', '$time', '8', '3', '$amt_id');";
    $dddd3="SELECT * FROM `distributor` WHERE `d_id`='$fet3[d_id]'";
    $sdcdd3=$con->query($dddd3);
    $lnm3=$sdcdd3->fetch_assoc();
    $withdrawal_wallet3=$lnm3[withdrawal_wallet]+8;
    $sql .="INSERT INTO `withdrawal_wallet` (`ww_id`, `d_id`, `date`, `time`, `type`, `amount`, `a_bal`, `note`, `income_for`, `from_d_id`, `to_d_id`, `activated_id`, `level`) VALUES (NULL, '$fet3[d_id]', '$date', '$time', '+', '8', '$withdrawal_wallet3', 'Auto Matrix Income', 'Auto Matrix', '', '', '', '3');";
...
if($que4->num_rows>0)
{
    $sql .="INSERT INTO `auto_matrix_income` (`ami_id`, `amt_id`, `d_id`, `date`, `time`, `amount`, `level`, `for_amt_id`) VALUES (NULL, '$fet4[amt_id]', '$fet4[d_id]', '$date', '$time', '8', '4', '$amt_id');";
    $dddd4="SELECT * FROM `distributor` WHERE `d_id`='$fet4[d_id]'";
    $sdcdd4=$con->query($dddd4);
    $lnm4=$sdcdd4->fetch_assoc();
    $withdrawal_wallet4=$lnm4[withdrawal_wallet]+8;
    $sql .="INSERT INTO `withdrawal_wallet` (`ww_id`, `d_id`, `date`, `time`, `type`, `amount`, `a_bal`, `note`, `income_for`, `from_d_id`, `to_d_id`, `activated_id`, `level`) VALUES (NULL, '$fet4[d_id]', '$date', '$time', '+', '8', '$withdrawal_wallet4', 'Auto Matrix Income', 'Auto Matrix', '', '', '', '4');";
...
if($que5->num_rows>0)
{
    $sql .="INSERT INTO `auto_matrix_income` (`ami_id`, `amt_id`, `d_id`, `date`, `time`, `amount`, `level`, `for_amt_id`) VALUES (NULL, '$fet5[amt_id]', '$fet5[d_id]', '$date', '$time', '7', '5', '$amt_id');";
    $dddd5="SELECT * FROM `distributor` WHERE `d_id`='$fet5[d_id]'";
    $sdcdd5=$con->query($dddd5);
    $lnm5=$sdcdd5->fetch_assoc();
    $withdrawal_wallet5=$lnm5[withdrawal_wallet]+7;
    $sql .="INSERT INTO `withdrawal_wallet` (`ww_id`, `d_id`, `date`, `time`, `type`, `amount`, `a_bal`, `note`, `income_for`, `from_d_id`, `to_d_id`, `activated_id`, `level`) VALUES (NULL, '$fet5[d_id]', '$date', '$time', '+', '7', '$withdrawal_wallet5', 'Auto Matrix Income', 'Auto Matrix', '', '', '', '5');";
...
if($que6->num_rows>0)
{
    $sql .="INSERT INTO `auto_matrix_income` (`ami_id`, `amt_id`, `d_id`, `date`, `time`, `amount`, `level`, `for_amt_id`) VALUES (NULL, '$fet6[amt_id]', '$fet6[d_id]', '$date', '$time', '5', '6', '$amt_id');";
    $dddd6="SELECT * FROM `distributor` WHERE `d_id`='$fet6[d_id]'";
    $sdcdd6=$con->query($dddd6);
    $lnm6=$sdcdd6->fetch_assoc();
    $withdrawal_wallet6=$lnm6[withdrawal_wallet]+5;
    $sql .="INSERT INTO `withdrawal_wallet` (`ww_id`, `d_id`, `date`, `time`, `type`, `amount`, `a_bal`, `note`, `income_for`, `from_d_id`, `to_d_id`, `activated_id`, `level`) VALUES (NULL, '$fet6[d_id]', '$date', '$time', '+', '5', '$withdrawal_wallet6', 'Auto Matrix Income', 'Auto Matrix', '', '', '', '6');";
...
if($que7->num_rows>0)
{
    $sql .="INSERT INTO `auto_matrix_income` (`ami_id`, `amt_id`, `d_id`, `date`, `time`, `amount`, `level`, `for_amt_id`) VALUES (NULL, '$fet7[amt_id]', '$fet7[d_id]', '$date', '$time', '4', '7', '$amt_id');";
    $dddd7="SELECT * FROM `distributor` WHERE `d_id`='$fet7[d_id]'";
    $sdcdd7=$con->query($dddd7);
    $lnm7=$sdcdd7->fetch_assoc();
    $withdrawal_wallet7=$lnm7[withdrawal_wallet]+4;
    $sql .="INSERT INTO `withdrawal_wallet` (`ww_id`, `d_id`, `date`, `time`, `type`, `amount`, `a_bal`, `note`, `income_for`, `from_d_id`, `to_d_id`, `activated_id`, `level`) VALUES (NULL, '$fet7[d_id]', '$date', '$time', '+', '4', '$withdrawal_wallet7', 'Auto Matrix Income', 'Auto Matrix', '', '', '', '7');";
...
if($que8->num_rows>0)
{
    $sql .="INSERT INTO `auto_matrix_income` (`ami_id`, `amt_id`, `d_id`, `date`, `time`, `amount`, `level`, `for_amt_id`) VALUES (NULL, '$fet8[amt_id]', '$fet8[d_id]', '$date', '$time', '3', '8', '$amt_id');";
    $dddd8="SELECT * FROM `distributor` WHERE `d_id`='$fet8[d_id]'";
    $sdcdd8=$con->query($dddd8);
    $lnm8=$sdcdd8->fetch_assoc();
    $withdrawal_wallet8=$lnm8[withdrawal_wallet]+3;
    $sql .="INSERT INTO `withdrawal_wallet` (`ww_id`, `d_id`, `date`, `time`, `type`, `amount`, `a_bal`, `note`, `income_for`, `from_d_id`, `to_d_id`, `activated_id`, `level`) VALUES (NULL, '$fet8[d_id]', '$date', '$time', '+', '3', '$withdrawal_wallet8', 'Auto Matrix Income', 'Auto Matrix', '', '', '', '8');";
...
if($que10->num_rows>0)
{
    $sql .="INSERT INTO `auto_matrix_income` (`ami_id`, `amt_id`, `d_id`, `date`, `time`, `amount`, `level`, `for_amt_id`) VALUES (NULL, '$fet10[amt_id]', '$fet10[d_id]', '$date', '$time', '2', '10', '$amt_id');";
    $dddd10="SELECT * FROM `distributor` WHERE `d_id`='$fet10[d_id]'";
    $sdcdd10=$con->query($dddd10);
    $lnm10=$sdcdd10->fetch_assoc();
    $withdrawal_wallet10=$lnm10[withdrawal_wallet]+2;
    $sql .="INSERT INTO `withdrawal_wallet` (`ww_id`, `d_id`, `date`, `time`, `type`, `amount`, `a_bal`, `note`, `income_for`, `from_d_id`, `to_d_id`, `activated_id`, `level`) VALUES (NULL, '$fet10[d_id]', '$date', '$time', '+', '2', '$withdrawal_wallet10', 'Auto Matrix Income', 'Auto Matrix', '', '', '', '10');";
