                     ...
                     <table id="datatable-buttons" class="table table-striped table-bordered" >
                      ...
                      <tbody>
                          <?php 
                                ...
                                {
                                    $e="SELECT * FROM `distributor` WHERE `a_status`='y' AND `a_date` BETWEEN '$_GET[from_date]' AND '$_GET[to_date]'";
                                }
                                else{
                                $e="SELECT * FROM `distributor` WHERE `a_status`='y'";}
                                //
                                $d=$con->query($e);
                                ...
                                <td><?php echo $R["a_date"]." / ". $R["a_time"]; ?></td>
                                </tr>
                                <?php $au++;     
                                } ?>
                      </tbody>
