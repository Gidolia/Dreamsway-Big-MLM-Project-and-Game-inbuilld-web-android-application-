...
<link rel="icon" href="../../small_logo.jpg" type="image/ico" />
    <title>DREAMSWAY || Add Remove PIN Wallet</title>
...
<?php
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                        <h4>PIN 3600 Current Wallet = <?php echo $xzxx[pin_3_wallet]+0;?>/-</h4>
        ...
        <table class="table table-striped table-bordered">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>3600 PIN Wallet Ledger View</h2>
        ...
        <table class="table table-striped table-bordered" id="datatable">
            ...
            <?php
            $a=0;
            $g="SELECT * FROM `pin_wallet_3600` WHERE `d_id`='$_GET[d_id]'";
            $dc=$con->query($g);
         ...
         <?php
            if(isset($_POST[opperaa]))
            {
                ...
                $fet=$xx->fetch_assoc();
                    ...
                    $wallet=$fet[pin_3_wallet]+$_POST[amount];
                    $r="UPDATE `distributor` SET `pin_3_wallet` = '$wallet' WHERE `distributor`.`d_id` = '$_POST[d_id]';";
                    
                    $r .="INSERT INTO `pin_wallet_3600` (`pw_id`, `d_id`, `date`, `time`, `pin`, `a_pin`, `note`, `type`, `activated_id`) VALUES (NULL, '$_POST[d_id]', '$date', '$time', '$_POST[amount]', '$wallet', 'Admin Add', '+', '');";
		...
		location.href='add_remove_pin3600.php?d_id=$_POST[d_id]';</script>";
                }
                else{
		...
		location.href='add_remove_pin3600.php?d_id=$_POST[d_id]';</script>";
                ...
                $fet=$xx->fetch_assoc();
                    ...
                    $r="UPDATE `distributor` SET `pin_3_wallet` = '$wallet' WHERE `distributor`.`d_id` = '$_POST[d_id]';";
                     ...
                     $r .="INSERT INTO `pin_wallet_3600` (`pw_id`, `d_id`, `date`, `time`, `pin`, `a_pin`, `note`, `type`, `activated_id`) VALUES (NULL, '$_POST[d_id]', '$date', '$time', '$_POST[amount]', '$wallet', 'Admin Remove', '-', '');";
