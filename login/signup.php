				...
				<div class="form-section">
					...
					<form action="#" method="post" class="signin-form" name="myForm" onsubmit="return validateForm()">
						...
						<div class="form-input">
							...
							<input type="text" name="s_name" placeholder="Sponser Name" value="<?php echo $dckm[name];?>" id="txtHint" required="" readonly>
    ...
    if(mysqli_num_rows($qur)==0)
    {
	    ...
	    if($d->num_rows>0)
	    {
	        if($_POST[password]==$_POST[c_password])
	        {
	            ...
	            {
	                $message='Welcome '.$_POST[name].' You are sucessfully Register Your ID=DS'.$d_id.' and Pass='.$_POST[password].' Oranga';
